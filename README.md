...
| TB2        | 29/06/2026 | Pablo Antonio Geronimo Quispe   | Implementó las interfaces relacionadas con la interacción de dispositivos inteligentes, desarrolló el microservicio IoT y participó en la construcción del prototipo funcional de la balanza inteligente del ecosistema Cobox Smart Vision. |
...
<table>
  ...
  <tr>
    <td>US-42</td>
    <td>Registro de Peso por Balanza Inteligente</td>
    <td>T-82</td>
    <td>Implementar servicio IoT y prototipo de balanza inteligente</td>
    <td>Desarrollar el servicio IoT y el prototipo físico de la balanza para registrar y sincronizar mediciones de peso.</td>
    <td>5</td>
    <td>Pablo Antonio Geronimo Quispe</td>
    <td>Done</td>
  </tr>
