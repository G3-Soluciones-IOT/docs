...
<p align="center">
  ...
  Startup: JF Technologies  - Producto: JameoFit <br><br>
...
| AV2     | 13/06/2026   | Pablo Antonio Geronimo Quispe | Desarrollo de vistas frontend orientadas a la interacción con dispositivos e implementación del servicio IoT |
...
| Entregable | Fecha      | Integrante                      | Actividades realizadas                                                                                                                                                                                                                      |
| TB2        | 29/06/2026 | Pablo Antonio Geronimo Quispe   | Implementó las interfaces relacionadas con la interacción de dispositivos inteligentes, desarrolló el microservicio IoT y participó en la construcción del prototipo funcional de la botella inteligente del ecosistema Cobox Smart Vision. |
| TB2        | 29/06/2026 | Mathias Eduardo Bueno Perales   | Elaboró el informe en las secciones 6.2.3.1, 6.2.3.2, 6.2.3.7 y 6.2.3.9, además de colaborar en la preparación de la presentación correspondiente a la entrega final.                                                                       |
| TB2        | 29/06/2026 | Omar Luquillas Asto             | Apoyó en el desarrollo de las interfaces de la aplicación web de escritorio y redactó las secciones 6.2.3.3 y 6.2.3.4 del informe técnico.                                                                                                  |
| TB2        | 29/06/2026 | Fabrizio Alberto Paredes Santos | Participó en la mejora y estabilización de los microservicios del backend, además de colaborar en la implementación de nuevas vistas para la aplicación web de escritorio.                                                                  |
| TB2        | 29/06/2026 | Jhon Alexander Galvez Chambi    | Realizó el despliegue de los servicios en la infraestructura de Google Cloud Platform (GCP), preparó la sección *Team Collaboration Insights* y contribuyó al desarrollo e integración de la aplicación móvil con el backend.               |
| TB2        | 29/06/2026 | Valentino Sandoval Paiva        | Desarrolló las interfaces de la aplicación web de escritorio, integró las funcionalidades con los microservicios del backend y brindó soporte técnico para la adecuación y estabilización de endpoints necesarios para las nuevas vistas.   |
| TB2        | 29/06/2026 | Ramiro Alexander Gúzman Chávez  | Implementó las interfaces de la aplicación móvil y realizó la integración de estas con los servicios del backend para el consumo y sincronización de datos.                                                                                 |
...
| Pablo Antonio Geronimo Quispe | `Phatogram` | Desarrollo de vistas en el frontend enfocadas en la interacción con dispositivos. Implementación del servicio de IoT y elaboración del prototipo físico para la botella inteligente del ecosistema Cobox Smart Vision. |
...
Para la elaboración de la entrega TB2 (Sprint Review – Semana 15) de este informe, el equipo se organizó mediante reuniones de coordinación a través de un canal de Discord y herramientas de gestión ágil. En estas reuniones se definió la prioridad de desarrollo centrada en la estabilización de microservicios, el despliegue del frontend y la integración de la solución IoT. Se asignaron responsables por capítulo y se establecieron fechas de revisión periódica para asegurar el avance progresivo y la mejora continua del producto.

| Integrante | Usuario Github | Detalle de avance |
|------------|----------------|-------------------|
| Valentino Sandoval Paiva | `ValentinoSandovalP` | Desarrollo de vistas de la aplicación frontend web (Desktop), integración con los microservicios del backend y apoyo técnico en la estabilización de *endpoints* adicionales requeridos para las nuevas interfaces. |
| Mathias Eduardo Bueno Perales | `MathiasBueno` | Redaccion del informe, secciones 6.2.3.1, 6.2.3.2, 6.2.3.7 y 6.2.3.9. Desarrollo de presentación final |
| Omar Luquillas Asto | `OmarLLA` | Colaboración en la implementación de vistas para la aplicación frontend web (Desktop). Desarollo de secciones 6.2.3.3, 6.2.3.4 |
| Pablo Antonio Geronimo Quispe | `Phatogram` | Desarrollo de vistas en el frontend enfocadas en la interacción con dispositivos. Implementación del servicio de IoT y elaboración del prototipo físico para la botella inteligente del ecosistema Cobox Smart Vision. |
| Ramiro Alexander Guzmán Chávez | `RamiroGuzmanCh` | Desarrollo e implementación de vistas para la aplicación frontend móvil y su respectiva conexión e integración de consumo de datos con el backend. |
| Jhon Alexander Galvez Chambi | `Chaomeum` | Despliegue de los servicios en la infraestructura de nube (GCP) y elaboración de la sección de *Team Collaboration Insights*. Desarrollo e implementación de vistas para la aplicación frontend móvil y su respectiva conexión e integración de consumo de datos con el backend.|
| Fabrizio Alberto Paredes Santos | `psfa29` | Colaboración en la estabilización de microservicios en el backend y desarrollo de vistas para el frontend web (Desktop). |

**Report Repository Insights:** En esta sección se presentan los analíticos de colaboración y los *commits* realizados en GitHub por los miembros del equipo dentro de nuestra organización y repositorio del informe durante la fase correspondiente al TB2. Esta evidencia permite visualizar la participación activa de los integrantes y la evolución del trabajo colaborativo a lo largo de este sprint.

- Report Contributors:
![Report Contributors](./assets/TF/report_contributors_tf.png)

- Report Network:
![Report Network](./assets/TF/report_network_tf.png)
...
| 42 | US-42 | Recomendaciones automáticas de alimentación (IA) | Como usuario, quiero recibir recomendaciones automáticas basadas en mis registros diarios. | 5 | Alta | Por Hacer |
| 43 | US-43 | Interacción con coach virtual | Como usuario, quiero interactuar con un coach virtual para obtener sugerencias guiadas. | 5 | Alta | Por Hacer |
| 44 | US-44 | Entrenamiento supervisado por nutricionista | Como nutricionista, quiero entrenar la IA con ejemplos de mis pacientes. | 5 | Alta | Por Hacer |
| 45 | US-45 | Limitar interacción IA | Como usuario, quiero que la IA me envíe solo sugerencias resumidas y limitadas. | 3 | Alta | Por Hacer |
| 46 | US-46 | Vinculación de Dispositivo IoT | Como usuario, quiero vincular mi dispositivo inteligente (botella) a mi cuenta para que los datos se registren automáticamente. | 3 | Alta | Por Hacer |
...
Este flujo de eventos describe cómo el sistema gestiona la rutina alimentaria del usuario de manera completamente automática mediante dispositivos IoT, como el bebedero inteligente. A partir de la captura de datos en tiempo real, el sistema registra el peso del alimento consumido y detecta automáticamente el tipo de alimento.
...
La relación visual entre IoT y las interfaces digitales debe mantenerse consistente: los datos capturados por la botella se reflejan posteriormente en módulos de progreso, hidratación, peso y análisis inteligente dentro de la plataforma. Así, el estilo no solo cumple una función estética, sino que también refuerza la trazabilidad entre la captura física de datos y la experiencia digital de seguimiento nutricional.
...
<p align="center">
  <img src="assets/TP/mqtt_flow_jameofit.jpg" alt="Arquitectura MQTT – JameoFit IoT" width="700"/>
</p>
...
![Sprint Backlog 2](assets/TB2/trello_board.png)
...
<table>
  ...
  <tr>
    ...
    <td colspan="1"><strong>Title</strong></td>
    <td colspan="1"><strong>Description</strong></td>
    <td colspan="1"><strong>Estimation (Story Points)</strong></td>
    <td colspan="1"><strong>Assigned To</strong></td>
    <td colspan="1"><strong>Status (To-do / In-Process / To-Review / Done)</strong></td>
  </tr>
  <tr>
    ...
    <td>T-77</td>
    <td>Implementar vistas de pacientes</td>
    <td>Incorporar las vistas de directorio, detalle, seguimiento y aceptación de pacientes para consultar su estado.</td>
    <td>5</td>
    <td>Valentino Sandoval Paiva</td>
    <td>Done</td>
  </tr>
  <tr>
    ...
    <td>Incorporar la vista de notificaciones sobre novedades de la aplicación y de los dispositivos IoT.</td>
    <td>2</td>
    <td>Valentino Sandoval Paiva</td>
    <td>Done</td>
  </tr>
  <tr>
    <td>US-33</td>
    <td>Chat Directo con Usuarios</td>
    <td>T-79</td>
    <td>Implementar vista de chat</td>
    <td>Incorporar la vista de comunicación para el intercambio directo entre nutricionista y usuario.</td>
    <td>5</td>
    <td>Valentino Sandoval Paiva</td>
    <td>Done</td>
  </tr>
  <tr>
    <td>US-34</td>
    <td>Gestión de Consultas</td>
    <td>T-80</td>
    <td>Implementar vista de consultas</td>
    <td>Incorporar la vista para organizar consultas y conversaciones dentro del módulo de comunicación.</td>
    <td>5</td>
    <td>Valentino Sandoval Paiva</td>
    <td>Done</td>
  </tr>
  <tr>
    <td>US-38</td>
    <td>Herramientas de Seguimiento de Pacientes</td>
    <td>T-81</td>
    <td>Implementar seguimiento móvil e integración IoT</td>
    <td>Incorporar las vistas de Smart Tracking IoT, historial IoT y vinculación de dispositivos para el monitoreo de usuarios.</td>
    <td>8</td>
    <td>Ramiro Alexander Guzmán Chávez / Pablo Antonio Geronimo Quispe</td>
    <td>Done</td>
  </tr>
</table>
...
![Services Documentation Evidence](assets/TF/ai_service_evidence_1.png)

![Services Documentation Evidence](assets/TF/ai_service_evidence_2.png)
...
![Services Documentation Evidence](assets/TF/nutritionist_evidence_1.png)

![Services Documentation Evidence](assets/TF/nutritionist_evidence_2.png)
...
| Endpoint | Acción | Método HTTP | Sintaxis de llamada | Parámetros | Ejemplo de Response | URL Documentación |
|----------|--------|-------------|---------------------|------------|---------------------|-------|
|  /api/v1/invoices/users/{userId}  |  Obtener facturas por usuario  | GET |  /api/v1/invoices/users/{userId} | userId (path) | [ { "id": 1, "userId": 42, "subscriptionId": 5, "amount": 9.99, "currency": "USD", "status": "PAID", "issuedAt": "2026-07-01T12:34:56" } ]  | (URL Swagger/doc) |
|  /api/v1/stripe-webhooks  | Procesar webhook de Stripe  | POST | /api/v1/stripe-webhooks | payload (body), Stripe-Signature (header)  | { "message": "Stripe webhook processed" }  | (URL Swagger/doc) |
| /api/v1/subscriptions  |  Crear una nueva suscripción  | POST |  /api/v1/subscriptions | body: userId, planType, billingCycle | { "id": 10, "userId": 42, "plan": { "id": 1, "planType": "PREMIUM", "billingCycle": "MONTHLY", "price": 9.99, "currency": "USD", "displayName": "Premium" }, "status": "PENDING_PAYMENT", "stripeCustomerId": null, "startedAt": "2026-07-01", "currentPeriodEnd": "2026-08-01", "stripePaymentIntentId": "pi_XXX", "stripeClientSecret": "cs_XXX" }  | (URL Swagger/doc) |
| /api/v1/subscriptions/{subscriptionId}/cancel  |  Cancelar suscripción  | POST | api/v1/subscriptions/{subscriptionId}/cancel  | subscriptionId (path) | { "id": 10, "userId": 42, "plan": { ... }, "status": "CANCELED", ... }   | (URL Swagger/doc) |
| /api/v1/subscriptions/{subscriptionId}/renew  | Renovar suscripción  | POST | /api/v1/subscriptions/{subscriptionId}/renew  | subscriptionId (path) | { "id": 10, "userId": 42, "plan": { ... }, "status": "ACTIVE", "stripePaymentIntentId": "pi_YYY", "stripeClientSecret": "cs_YYY" }  | (URL Swagger/doc) |
| /api/v1/subscriptions/users/{userId}/active  | Obtener suscripción activa por usuario  | GET | /api/v1/subscriptions/users/{userId}/active | userId (path)  | 200: { "id": 10, "userId": 42, "plan": { ... }, "status": "ACTIVE", ... } OR 204 No Content  | (URL Swagger/doc) |
| /api/v1/internal/subscriptions/users/{userId}/premium-access  | Verificar acceso premium (interno)  | GET | /api/v1/internal/subscriptions/users/{userId}/premium-access | userId (path)  | { "userId": 42, "premiumAccess": true }  | (URL Swagger/doc) |

![Services Documentation Evidence](assets/TF/payment_evidence_1.png)

![Services Documentation Evidence](assets/TF/payments_evidence_2.png)
...
7. ¿La sección de comunicación con el nutricionista cubre lo que esperarías de una consulta digital?

8. ¿Pagarías por una suscripción a esta plataforma? ¿Qué tendría que ofrecerte para que valga la pena?

9. ¿Recomendarías JameoFit a alguien que quiere mejorar sus hábitos alimenticios? ¿Por qué?
...
6. ¿La integración con dispositivos IoT (botella) te genera confianza en los datos que recibirías de tus pacientes?
...
- Monitoreo automatizado y sincronización con dispositivos IoT ( hidratación inteligente)
...
- Descripción: Basado en las observaciones de Miguel Salas y Cristina Sihuas, la confianza del profesional en los datos depende enteramente de que la botella inteligente este correctamente calibrada y sincronizada. La interfaz actual no muestra activamente si un dispositivo ha perdido conexión, está descalibrado o si los datos mostrados están desactualizados. <br>
...
- URL Frontend Mobile
  https://g3-soluciones-iot.github.io/mobile/
  
- URL Backend:
  https://jameofit.duckdns.org/webjars/swagger-ui/index.html?urls.primaryName=iam-service
